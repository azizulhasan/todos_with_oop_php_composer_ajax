  ...
  $(function () {
    ...
    *************************************************/
    $(".todo_item_box").on("click", ".delete_todo ", function (e) {
      ...
      $.ajax({
        ...
        dataType: "json",
        url: "" + "/php/todo/api/todoDelete.php",
        success: function (data) {
          if (data.status == 1) {
            let itemLeft = $(".todo_item_box div.todo_body div.active_task")
              .length;
    ...
    *************************************************/
    $(".clear_completed_task").on("click", function () {
      ...
      $.ajax({
        data: { id: com_id },
        url: "" + "/php/todo/api/todoDeleteAll.php",
        type: "POST",
        dataType: "json",
        success: function (data) {
          if (data) {
